...
function startServer() {
  ...
  // Temporary test route for Cosmos DB
  ...
  // Example updated route (register) using Cosmos DB / SQLite fallback
  app.post("/api/register", async (req, res) => {
    try {
      ...
      const user = {
        id: Date.now().toString(), // String ID required by Cosmos DB
        email,
  ...
  // Example updated route (login) using Cosmos DB / SQLite fallback
